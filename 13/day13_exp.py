###############################################################
# First describe bug then think what all, ways it can be produced and then try to come up with solution
...
# Evaluating each line using debugger is good if project is too big to run limited scope of project
